...
#ifndef SMART_CANE_INTERFACES__MSG__DETAIL__DETECTION_RESULT__FUNCTIONS_H_
#define SMART_CANE_INTERFACES__MSG__DETAIL__DETECTION_RESULT__FUNCTIONS_H_
 ...
 * calls
 * smart_cane_interfaces__msg__DetectionResult__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_cane_interfaces
smart_cane_interfaces__msg__DetectionResult *
smart_cane_interfaces__msg__DetectionResult__create(void);

/// Destroy msg/DetectionResult message.
/**
 * It calls
 * smart_cane_interfaces__msg__DetectionResult__fini()
 ...
 * smart_cane_interfaces__msg__DetectionResult__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * smart_cane_interfaces__msg__DetectionResult__Sequence__fini()
 * on the array,
...
#endif  // SMART_CANE_INTERFACES__MSG__DETAIL__DETECTION_RESULT__FUNCTIONS_H_
