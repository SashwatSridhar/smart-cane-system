...
static const _UltrasonicData_type_support_symbol_names_t _UltrasonicData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smart_cane_interfaces, msg, UltrasonicData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smart_cane_interfaces, msg, UltrasonicData)),
  }
};
...
{
  return &::smart_cane_interfaces::msg::rosidl_typesupport_cpp::UltrasonicData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smart_cane_interfaces, msg, UltrasonicData)() {
  return get_message_type_support_handle<smart_cane_interfaces::msg::UltrasonicData>();
}
