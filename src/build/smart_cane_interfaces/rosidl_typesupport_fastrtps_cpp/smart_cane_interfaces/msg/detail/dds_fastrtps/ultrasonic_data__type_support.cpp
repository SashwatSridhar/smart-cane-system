...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smart_cane_interfaces::msg::UltrasonicData & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const smart_cane_interfaces::msg::UltrasonicData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smart_cane_interfaces::msg::UltrasonicData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UltrasonicData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const smart_cane_interfaces::msg::UltrasonicData *>(
...
static size_t _UltrasonicData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UltrasonicData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UltrasonicData__callbacks = {
...
{
  return &smart_cane_interfaces::msg::typesupport_fastrtps_cpp::_UltrasonicData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smart_cane_interfaces, msg, UltrasonicData)() {
  return &smart_cane_interfaces::msg::typesupport_fastrtps_cpp::_UltrasonicData__handle;
}
