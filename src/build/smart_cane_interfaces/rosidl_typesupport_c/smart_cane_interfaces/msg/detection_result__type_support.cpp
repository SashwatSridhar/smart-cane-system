...
static const _DetectionResult_type_support_symbol_names_t _DetectionResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smart_cane_interfaces, msg, DetectionResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, smart_cane_interfaces, msg, DetectionResult)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, smart_cane_interfaces, msg, DetectionResult)() {
  return &::smart_cane_interfaces::msg::rosidl_typesupport_c::DetectionResult_message_type_support_handle;
}
