...
#include "smart_cane_interfaces/msg/detail/feedback_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smart_cane_interfaces::msg::FeedbackCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_smart_cane_interfaces
max_serialized_size_key_FeedbackCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const smart_cane_interfaces::msg::FeedbackCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smart_cane_interfaces::msg::FeedbackCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FeedbackCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const smart_cane_interfaces::msg::FeedbackCommand *>(
...
static size_t _FeedbackCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FeedbackCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FeedbackCommand__callbacks = {
...
static rosidl_message_type_support_t _FeedbackCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FeedbackCommand__callbacks,
...
{
  return &smart_cane_interfaces::msg::typesupport_fastrtps_cpp::_FeedbackCommand__handle;
}
