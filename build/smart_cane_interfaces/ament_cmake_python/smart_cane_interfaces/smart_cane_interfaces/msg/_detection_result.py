    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'smart_cane_interfaces.msg.DetectionResult')
            logger.debug(
...
class DetectionResult(metaclass=Metaclass_DetectionResult):
    ...
    _fields_and_field_types = {
        ...
        'object_positions': 'sequence<geometry_msgs/Point>',
    ...
    def __init__(self, **kwargs):
        ...
        self.object_positions = kwargs.get('object_positions', [])
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'object_positions' field must be a set or sequence and each value of type 'Point'"
