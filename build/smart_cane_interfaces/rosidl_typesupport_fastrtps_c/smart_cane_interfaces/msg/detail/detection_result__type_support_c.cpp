...
#include "smart_cane_interfaces/msg/detail/detection_result__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // object_positions
...
using _DetectionResult__ros_msg_type = smart_cane_interfaces__msg__DetectionResult;
  ...
  smart_cane_interfaces__msg__DetectionResult * ros_message)
{
  ...
  // Field name: object_positions
  {
    ...
    if (ros_message->object_positions.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->object_positions);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->object_positions, size)) {
      fprintf(stderr, "failed to create array for field 'object_positions'");
      return false;
    }
    auto array_ptr = ros_message->object_positions.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smart_cane_interfaces__msg__DetectionResult;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const smart_cane_interfaces__msg__DetectionResult * ros_message = static_cast<const smart_cane_interfaces__msg__DetectionResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_smart_cane_interfaces__msg__DetectionResult(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  smart_cane_interfaces__msg__DetectionResult * ros_message = static_cast<smart_cane_interfaces__msg__DetectionResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_smart_cane_interfaces__msg__DetectionResult(cdr, ros_message);
}

static uint32_t _DetectionResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smart_cane_interfaces__msg__DetectionResult(
...
static size_t _DetectionResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smart_cane_interfaces__msg__DetectionResult(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smart_cane_interfaces, msg, DetectionResult)() {
